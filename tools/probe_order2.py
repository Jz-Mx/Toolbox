...
def probe(window):
    ...
    print("  gpu has slash:", ev_js(window, "document.getElementById('dGpu').textContent.includes(' / ')"), flush=True)
    print("PROBE_ORDER2_DONE", flush=True)
